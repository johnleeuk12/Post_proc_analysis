...
[Pool{1}, rate{1}, raster{1}] = pool_data(2320,10,40,60);
% [Pool{1}, rate{1}, raster{1}] = pool_data(1,[2,3,6],60,1180);
% [Pool{2}, rate{2}, raster{2}] = pool_data(104,8,40);
% [Pool{1}, rate{1}, raster{1}] = pool_data(2335,[5,6,15,16],40);
...
save('E:\DATA\Combined\ana_population\Dynamics_SUrate\AL_Phee_all_latest.mat','SUrate','-v7.3','-nocompression');
